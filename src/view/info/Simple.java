...
//        comboBoxGen.getItems().add("CPU"); // Fonctionne que avec linux
    ...
    public void save(ActionEvent actionEvent){
        ...
        switch (gen){
            ...
            case "de -60 à 100":
                ...
                break;
            // Fonctionne que avec linux :
//            case "CPU":
//                capteurSimple.setGenerationStrategie(new GenerationCPU());
//                break;
            default:
        ...
        capteurSimple.setActive(!toggleButtonActive.isSelected());
    }
}
